...
func (*String) Descriptor() ([]byte, []int) {
	return fileDescriptor_publish4_4_3_e003e95c5c52d153, []int{0}
}
...
func init() {
	proto.RegisterType((*String)(nil), "publish.String")
}
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/publish.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/publish.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publish.PubsubService/Publish",
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "publish.PubsubService",
	...
	Metadata: "publish4_4_3.proto",
}

func init() { proto.RegisterFile("publish4_4_3.proto", fileDescriptor_publish4_4_3_e003e95c5c52d153) }

var fileDescriptor_publish4_4_3_e003e95c5c52d153 = []byte{
	// 133 bytes of a gzipped FileDescriptorProto
	,
}
